        ...
        <div class="container-fluid re-container-fluid">
            ...
            <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a style="padding: 0; marginRight: 10px" href="<?php echo base_url(); ?>" style="pointer-events: none"><img style="width: 50px" src="<?php echo base_url(); ?>upload/logo.png" alt="" class="img-responsive"></a></li>
