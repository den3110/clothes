		...
		<div class="col-lg-12">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form action="#" class="form-horizontal" name="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="image" name="image" <?php echo set_value('image') ?>>
							</div>
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">Hình ảnh kèm theo</label>
							<div class="col-sm-5">
								<input type="text" id="list_image" name="list_image[]" multiple>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-5">
								<button onclick="addProduct()" type="submit" class="btn btn-primary">Thêm mới</button>
							</div>
						</div>
					</form>
				</div>
	...
	<script>
		async function addProduct() {
			const res= await axios({
				url: "http://localhost/shopbanquanao/request/add.php",
				method: "post",
				data: {
